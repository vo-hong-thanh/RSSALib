...
//                    System.out.println("updated delayed reaction");                    
                    ...
                    if (!updateReactions.isEmpty()){
                        double oldTotalMaxPropensity = totalMaxPropensity;
                        updateRDMNodeArray(updateReactions);
                        currentTime = (currentTime - storedDelayTime)*(oldTotalMaxPropensity/totalMaxPropensity) + storedDelayTime;
                        updateStep++;
